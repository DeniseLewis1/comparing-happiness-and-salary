...
# print(f"Countries with largest average happiness: {happiness_average_per_country.nlargest(10)}")
# print(f"Countries with smallest average happiness: {happiness_average_per_country.nsmallest(10)}")
